			...
			<div class="p-3">
				...
				<div
					...
					<div class="relative w-full md:w-2/3">
						<i
							class="pi pi-search text-gray-500 dark:text-gray-300 absolute left-3 top-1/2 transform -translate-y-1/2"></i>
						<input
				...
				<!-- Loading Indicator -->
				<div
					class="text-center text-gray-600 dark:text-gray-300 py-5">
